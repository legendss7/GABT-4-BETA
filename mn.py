...
def generate_gatb_questions():
    ...
    test_data = {
        "Razonamiento General": {"code": "G", "items": [("Pregunta G1", {"a": "A", "b": "B", "c": "C", "d": "D"}, "c")] * 12},
        "Razonamiento Verbal": {"code": "V", "items": [("Pregunta V1", {"a": "A", "b": "B", "c": "C", "d": "D"}, "b")] * 12},
        "Razonamiento Numérico": {"code": "N", "items": [("Pregunta N1", {"a": "A", "b": "B", "c": "C", "d": "D"}, "a")] * 12},
        "Razonamiento Espacial": {"code": "S", "items": [("Pregunta S1", {"a": "A", "b": "B", "c": "C", "d": "D"}, "d")] * 12},
        "Velocidad Perceptiva": {"code": "P", "items": [("Pregunta P1", {"a": "A", "b": "B", "c": "C", "d": "D"}, "b")] * 12},
        "Precisión Manual": {"code": "Q", "items": [("Pregunta Q1", {"a": "A", "b": "B", "c": "C", "d": "D"}, "c")] * 12},
        "Coordinación Manual": {"code": "K", "items": [("Pregunta K1", {"a": "A", "b": "B", "c": "C", "d": "D"}, "a")] * 12},
        "Atención Concentrada": {"code": "A", "items": [("Pregunta A1", {"a": "A", "b": "B", "c": "C", "d": "D"}, "d")] * 12},
        "Razonamiento Mecánico": {"code": "M", "items": [("Pregunta M1", {"a": "A", "b": "B", "c": "C", "d": "D"}, "b")] * 12},
        "Razonamiento Abstracto": {"code": "R", "items": [("Pregunta R1", {"a": "A", "b": "B", "c": "C", "d": "D"}, "c")] * 12},
        "Razonamiento Clerical": {"code": "C", "items": [("Pregunta C1", {"a": "A", "b": "B", "c": "C", "d": "D"}, "a")] * 12},
        "Razonamiento Técnico": {"code": "T", "items": [("Pregunta T1", {"a": "A", "b": "B", "c": "C", "d": "D"}, "d")] * 12},
    }
    ...
    for area_name in AREAS:
        ...
        # Simulación de respuesta correcta. Usamos 'c' para un grupo y 'a' o 'd' para otros para simular variedad
        if area_name in ["Razonamiento General", "Razonamiento Verbal", "Razonamiento Numérico"]:
            expected_answer = "c"
        elif area_name in ["Razonamiento Clerical"]:
            expected_answer = "a"
        else:
            expected_answer = "d" # Default para otros
        ...
        for i, (pregunta, opciones, respuesta) in enumerate(items_to_use):
            ...
            questions.append({
                ...
                "area": area_name,
                "code": code,
                "pregunta": f"Pregunta {code}-{i+1}. (Simulada)",
